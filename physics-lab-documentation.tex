...
\begin{document}
    ...
    etwa \SI{9.81}{\metre\per\square\second}.

    Wir möchten in unserem Experiment ähnliche Versuche ausführen und
    somit $g$ ungefähr bestimmen. Wir haben jedoch mittlerweile wesentlich
    genauere Messmethoden. Daher verwenden wir ein Schallmessgerät, um
    die Beschleunigung von Objekten auf einer schiefen Bahn zu bestimmen
    und Excel, um diese in einer Tabellenform darzustellen.
