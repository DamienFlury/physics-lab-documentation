...
\begin{document}
    ...
    \begin{figure}
        \centering
        \subfloat[Optimale lineare Approximation] {{\includegraphics[width = 5cm]{images/extrapolation_small}}}
        \qquad
        \subfloat[Extrapolation] {{\includegraphics[width = 5cm]{images/extrapolation_large}}}
    ...
    \begin{figure}
        \centering
        \subfloat[Optimale lineare Approximation] {{\includegraphics[width = 5cm]{images/extrapolation_cart_small}}}
        \qquad
        \subfloat[Extrapolation] {{\includegraphics[width = 5cm]{images/extrapolation_cart_large}}}
